...
The measurement length, i.e., how long the protocol should last, and the sampling interval, i.e., how often measurements are taken, is partially determined by the battery and storage capacity of the device, and highly contingent on the research question. If the goal is to measure or approximate the retinal stimulus at high temporal resolution, then of course, 1-minute measurements 
