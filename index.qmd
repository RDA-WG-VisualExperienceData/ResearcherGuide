...
#| echo: true
#| fig-width: 12
irregular_data <- sample.data.environment |> add_Date_col(as.wday = TRUE) |> mutate(Datetime = ifelse(Date == "Wed", Datetime +5, Datetime) |> as.POSIXct())
irregular_data |> 
...
sample.data.environment |> 
  ...
  gg_days(geom = "ribbon", alpha = 0.5, aes_fill = "ID") |> 
