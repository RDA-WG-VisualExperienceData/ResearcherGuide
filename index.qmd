...
# Outline of the Research Guide

## Selecting Devices

### Measurement capabilities and sensor characteristics
Spectral/photometric/α-opic metrics, sampling rate, uncertainty, cosine response, range, etc.
...
Dimensions, durability, occlusion susceptibility.
...
### Software ecosystem
Features for annotation, tagging, and version control.
