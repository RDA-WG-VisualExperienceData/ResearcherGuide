...
flowchart LR
    ...
    click A "https://example.com/selecting-devices" _blank
    click B "https://example.com/designing-study" _blank
    click C "https://example.com/collecting-data" _blank
    click D "https://example.com/storing-data" _blank
    click E "https://example.com/analysing-data" _blank
    click F "https://example.com/reporting-data" _blank
    click G "https://example.com/validating-devices" _blank
    click H "https://example.com/maintaining-devices" _blank
```
